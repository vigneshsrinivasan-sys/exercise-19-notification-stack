...
**Primary practice:** Status-driven component rows

## What I built

A stack of notification rows uses repeated structure, status color, borders, and hover treatment to make operational messages scannable.
